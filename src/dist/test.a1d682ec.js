...
})({"l7prI":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "db21f3ffa1d682ec";
"use strict";
...
},{}],"2dmYb":[function(require,module,exports) {
...
formData.append("scope", "user-read-private user-modify-playback-state user-read-playback-state");
const userCredentials = (0, _buffer.Buffer).from(`${"945891137e5c466c94d879ed8de8f01d"}:${"4768904910b349359d301b49c7de3b6b"}`, "utf-8").toString("base64");
...
console.log((0, _buffer.Buffer).from("hi this is how its done", "utf-8").toString("base64"));
const authUrl = `${"https://accounts.spotify.com/api/token"}?client_id=${"945891137e5c466c94d879ed8de8f01d"}&redirect_uri=${"http://localhost:1234"}&scope=${SCOPES.join("%20")}&response_type=code`;
...
},{}]},["l7prI","1xC6H","2dmYb"], "2dmYb", "parcelRequire94c2")

//# sourceMappingURL=test.a1d682ec.js.map
